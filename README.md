...
- [Resumo](01_linguagem_python/01_introducao/resumo.md)
...
- [Tensores - Úteis](02_bibliotecas/pytorch/tensores-uteis.md)
- [Tipos de Tensores](02_bibliotecas/pytorch/tensores-tipos.md)
- [Criar Tensores](02_bibliotecas/pytorch/tensores-criar.md)
- [Operações com Tensores](02_bibliotecas/pytorch/tensores-operacoes.md)
- [Indexar Tensores](02_bibliotecas/pytorch/tensores-indexar.md)
- [Converter Tensores](02_bibliotecas/pytorch/tensores-converter.md)
- [Concatenar Tensores](02_bibliotecas/pytorch/tensores-concatenar.md)

#### Numpy

- [Úteis](02_bibliotecas/numpy/numpy-uteis.md)
- [Criar arrays Numpy](02_bibliotecas/numpy/numpy-criar.md)
- [Indexar arrays Numpy](02_bibliotecas/numpy/numpy-indexar.md)

#### Pandas

- [Úteis](02_bibliotecas/pandas/pandas-uteis.md)
- [Criar DF](02_bibliotecas/pandas/pandas-criar.md)

#### Matplotlib

- [Úteis](02_bibliotecas/matplotlib/matplotlib-uteis.md)
- [Plot](02_bibliotecas/matplotlib/matplotlib-plot.md)

#### OpenCV

- [Lendo e exibindo uma imagem](02_bibliotecas/opencv/lendo-exibindo-imagem.md)
- [Lendo e exibindo um vídeo](02_bibliotecas/opencv/lendo-exibindo-video.md)
- [Salvando uma cópia de uma imagem](02_bibliotecas/opencv/salvando-copia-imagem.md)
- [Salvando uma cópia de um vídeo (webcam)](02_bibliotecas/opencv/salvando-copia.video.md)

## **Úteis**

- [CLI](A_uteis/linha-comando.md)
- [Criando um .venv](A_uteis/venv.md)
- [PIP](A_uteis/pip.md)
- [Conda](A_uteis/conda.md)
- [Diversos](A_uteis/diversos.md)
...
- [Lendo uma entrada no Beecrowd](B_exemplos/beecrowd/lendo-entradas.md)    
...
- [Matemática](B_exemplos/beecrowd/matematica.md)
- [Adhoc](B_exemplos/beecrowd/adhoc.md)
- [Strings](B_exemplos/beecrowd/strings.md)

#### Diversos

- [Usando o webservice ViaCEP](B_exemplos/diversos/ex-viacep.md)
- [Usando a API pokemons](B_exemplos/diversos/ex-pokemon.md)
- [Pegar o código fonte de qualquer página](B_exemplos/diversos/ex-source-code.md)
- [Diversos](B_exemplos/diversos/diversos.md)
